export default {
  ...
  maxMessagesN:            (n) => `Up to <strong>${n} messages</strong> as a guest`,
  unlimitedMessages:       "<strong>Unlimited</strong> messages",
  e2eEncrypted:            "End-to-end encrypted",
  verifiedOrgBadge:        "Verified organization",
  verifiedCertLine:        (date, method) => `Identity verified on <strong>${date}</strong> via ${method}`,
  verifiedMethods: {
    medreg_psyreg_refdata: "official register check (MedReg/PsyReg + RefData)",
    zefix_uid:             "commercial register / UID check (Zefix)",
    bfs_gemeinde:          "official municipality directory (BFS)",
    zewo_statuten:         "Zewo / statutes check",
    domain_txt:            "domain verification",
    contract_invoice:      "contract & invoice to the registered address",
    swiyu_trust_registry:  "swiyu trust registry",
  },
  accessUntilDate:         (date) => `Access at least until <strong>${date}</strong> — keep it forever with a Passkey`,
  noEmergencyChannel:      "Not an emergency channel. In an emergency: <strong>144</strong> (ambulance) · <strong>143</strong> (helpline)",
  neverAsksPayment:        "RENEX will never ask for card, bank or password details.",
  authCodeLabel:           "Activation code",
  authCodeHint:            "The organization sent you this code separately (e.g. by letter, phone or in person).",
  authCodeWrong:           "Invalid code — {n} attempt(s) left.",
  authCodeLocked:          "Too many failed attempts. Please contact the organization.",
  authCodeInvalid:         "Could not verify the code.",
  reEntryHint:             "This card has already been activated. Joining will <strong>re-activate the channel on this device</strong> — previous access will be ended. Earlier messages remain encrypted.",
