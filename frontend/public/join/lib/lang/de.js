export default {
  ...
  authCodeLabel:           "Aktivierungscode",
  authCodeHint:            "Den Code hat Ihnen die Organisation separat mitgeteilt (z.B. per Brief, Telefon oder persönlich).",
  authCodeWrong:           "Code ungültig — noch {n} Versuch(e).",
  authCodeLocked:          "Zu viele Fehlversuche. Bitte wenden Sie sich an die Organisation.",
  authCodeInvalid:         "Code konnte nicht geprüft werden.",
