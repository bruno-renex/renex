export default {
  ...
  addDeviceStep1:          "On the new device, open app.renex.id.",
  ...
  addDeviceConvenienceTip: "💡 Tip: scan this QR with your new device's camera to open app.renex.id directly (saves typing the URL).",
