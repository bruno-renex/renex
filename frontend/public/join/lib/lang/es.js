export default {
  ...
  authCodeLabel:           "Código de activación",
  authCodeHint:            "La organización le comunicó este código por separado (p. ej. por carta, teléfono o en persona).",
  authCodeWrong:           "Código no válido — quedan {n} intento(s).",
  authCodeLocked:          "Demasiados intentos fallidos. Contacte con la organización.",
  authCodeInvalid:         "No se pudo verificar el código.",
